...
def parse_args_and_config():
    ...
    parser.add_argument("--config", default='/kaggle/working/CFWD_do_an/CFWD/configs/LOLv1.yml', type=str,
                        help="Path to the config file")
    parser.add_argument('--resume', default='/kaggle/input/cfwd-weight/pre_prompt_pair.pth', type=str,
                        help='Path for the diffusion model checkpoint to load for evaluation')
    parser.add_argument("--sampling_timesteps", type=int, default=10,
                        help="Number of implicit sampling steps")
    parser.add_argument("--image_folder", default='/kaggle/working/results_CFWD', type=str,
